...
class TextRNN(Classifier):
    ...
    def forward(self, batch):
        ...
        #bert_model = BertModel.from_pretrained('/users3/xmshi/2018_1/contextualLUDSTC4_Bert/bert/model').to(self.config.device)
        #with torch.no_grad():
        #    embedding = bert_model(batch[cDataset.DOC_TOKEN].to(self.config.device))[0]
